...
const SECURITY_HEADERS: Record<string, string> = {
  ...
  "default-src 'self'; img-src 'self' data: https://flagcdn.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com; font-src 'self' https://fonts.gstatic.com https://cdnjs.cloudflare.com; script-src 'self';",
};
