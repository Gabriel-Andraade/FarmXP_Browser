...
export default {
  ...
  saveSlots: {
    ...
    exportInvalid: 'Este save está corrompido — exportação cancelada.',
    importSuccessUnverified: 'Save importado (sem verificação de integridade).',
    importInvalidJson: 'Arquivo ilegível — não é um JSON válido.',
    importNotASave: 'Este arquivo não é um save do Farming XP.',
    importChecksumMismatch: 'Arquivo corrompido ou editado — nada foi alterado.',
