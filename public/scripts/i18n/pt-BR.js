...
export default {
  ...
  quests: {
    lunaChick: {
      title: 'O bichinho da Luna',
      description: 'Levar um filhote para a Luna cuidar.',
    },
    title: 'Missões',
    ...
    lucasDrill: {
      title: 'A parafusadeira do John',
      description: 'O Lucas quebrou a parafusadeira do pai e precisa decidir o que fazer.',
    },
    tutorial: {
      firstMeeting: {
        title: 'Se apresentar',
  ...
  npc: {
    ...
    family: {
      ...
      askJohn: {
        option: 'Cadê o seu pai?',
        molly: {
          engineering: 'Tá numa obra desde cedo. Chega lá pelas {hora}.',
          security: 'Saiu pra um serviço. Só volta de madrugada, meu bem.',
          airforce: 'Tá voando. Volta {dia}.',
        },
        lucas: {
          engineering: 'Obra. Ele volta às {hora}.',
          security: 'Serviço de segurança. Só de madrugada.',
          airforce: '...Ele tá voando. Volta {dia}.',
        },
        isabela: {
          engineering: 'Sei lá. Trabalhando, oras.',
          security: 'Saiu. Já perguntou pra minha mãe?',
          airforce: 'caça. É coisa de militar. Volta... {dia}? eu acho.',
        },
        reactStella: '...Ele descansa quando?',
        reactGraham: 'Três empregos.',
        reactBen: 'E eu achando que a fazenda era pesada.',
      },
      ...
      lunaChick: {
        johnNo: 'Molly, não.',
        mollyVisit: 'Ela vai adorar receber visita, John.',
        johnAsk: 'A fazenda é dela. A gente pergunta antes.',
        mollyKitchen: 'Você pergunta antes até pra entrar na própria cozinha.',
        lunaWant: 'PAI. Eu quero um bicho pra cuidar. Um só. Pequenininho.',
        johnLuna: 'Luna—',
        lunaSchool: 'A tia da escolinha falou que na fazenda tem filhote. E filhote precisa de alguém pra cuidar. EU posso cuidar.',
        mollyNotice: 'Ooooi! Tudo bem com você? A gente ia visitar sua fazenda!',
        reactStella: 'Vi— visitar? A minha?',
        reactGraham: 'Visitar a fazenda?',
        reactBen: 'Peraí. Vocês iam lá? Agora?',
        johnSurprise: 'Elas iam. De surpresa. Sem perguntar.',
        mollyChicks: 'A Luna aprendeu que fazenda tem filhote. E eu acho que um bichinho em casa faria um bem danado.',
        johnLater: 'A gente conversa sobre isso em casa.',
        johnNoticesGraham: '...Tudo bem.',
        optAnytime: 'Podem aparecer quando quiserem.',
        optJohnRight: 'O John tem razão. Prefiro que avisem antes.',
        optDepends: 'Depende do dia. Hoje não seria bom.',
        mollyToldYou: 'AHAH! Eu te falei!',
        johnAsked: 'Só disse sim porque perguntaram. Era só isso que eu queria.',
        mollyHmph: 'Hmph.',
        mollyTwoNow: 'Ah, não... agora são dois? Que injustiça.',
        johnThanks: 'Obrigado.',
        mollyFine: 'Ah... claro, claro. A gente combina antes, então.',
        lunaSaw: 'MÃAAAAAAAAAAAAE, VOCÊ VIU? ELE FALOU QUE PODE!',
        johnInside: 'Luna... vai pra dentro, querida?',
        lunaNo: 'Não!',
        johnLunaFirm: 'Luna.',
        mollyJohn: 'John.',
        mollyAskPet: 'Ei, teria algum bichinho que a Luna poderia tomar conta?',
        johnBetterNot: 'Amor... melhor não.',
        mollyStare: 'Molly lança um olhar para John, acompanhado de um belo sorriso. Estranhamente, o olhar apavora até você.',
        stareStella: '...Eu preciso aprender a fazer isso.',
        stareGraham: 'Já enfrentei coisa pior. ...Acho.',
        stareBen: 'Nunca mais contrario essa mulher. Nunca.',
        johnFine: 'Ok... algum bichinho pra ela poder cuidar. Se der.',
        optPromise: 'Tenho sim. Quando nascer um filhote, é dela.',
        optFatherDecides: 'Posso ver. Mas quem decide é o pai dela.',
        optRefuse: 'Bicho não é brinquedo. Ela é pequena demais.',
        reactPromise: 'Ouviu, Luna? Olha só esse coração.',
        reactFather: 'John olha para você por um segundo a mais do que o normal.',
        reactRefuse: 'Luna abaixa a cabeça e não diz nada.',
        farmGuiltStella: 'Ela só queria um bichinho. Só isso. ...Eu também só queria umas coisas, quando tinha essa idade.',
        farmGuiltGraham: 'Foi a resposta certa. Uma criança de seis anos não cuida de um animal sozinha. ...Então por que eu ainda tô pensando nisso?',
        farmGuiltBen: 'Beleza, eu fui o adulto responsável. Uau. Que sensação horrível.',
        johnEasyOne: 'Só... que seja um fácil. Um que não atrapalhe.',
        pickPrompt: 'Qual filhote levar pra Luna?',
        optChick: 'Um pintinho.',
        optLamb: 'Um cordeiro.',
        optPiglet: 'Um porquinho.',
        lunaChickJoy: 'Um pintinho! Ele cabe na minha mão!',
        lunaLambJoy: 'UM CORDEIRO? DE VERDADE? ELE É MAIOR QUE O THEO!',
        lunaPigletJoy: 'UM PORQUINHO!!! PAI, EU VOU CHAMAR ELE DE—',
        johnNotYet: 'Ainda não.',
        objective: 'Levar um filhote para a Luna.',
        objectiveDeliver: 'Entregar o filhote para a Luna.',
        dLunaSees: 'É ELE! É ELE! MÃE, OLHA!',
        dJohnNo: 'Luna. A gente não vai ter bicho dentro de casa.',
        dLunaPlead: 'Mas eu cuido! Eu prometo! Eu já sei até o nome dele!',
        dJohnFirm: 'Eu já falei.',
        dJohnRemembers: 'Você perguntou pra mim, da última vez. Eu não esqueci disso.',
        dOptMolly: 'Molly, o que você acha?',
        dOptInsist: 'Ela dá conta, John.',
        dOptQuiet: '*Entregar o filhote pra Luna sem dizer nada*',
        dMollyThinks: 'Eu acho que essa casa tá precisando de um barulho novo.',
        dJohnMolly: 'Molly—',
        dMollyFinal: 'John.',
        dJohnCaves: '*suspira* ...Dentro de casa, não. No quintal.',
        dJohnPressed: 'Eu ouvi. E eu disse não.',
        dMollyStepsIn: 'John. Deixa a menina.',
        dJohnCavesB: '*pausa longa* ...No quintal.',
        dQuietGive: 'Você põe o filhote nas mãos da Luna sem dizer nada. Ela abraça o bichinho como se alguém fosse tomar.',
        dJohnSees: 'Eu vi.',
        dJohnLater: 'A gente conversa sobre isso em casa.',
        dLunaThanks: 'Obrigada. Obrigada, obrigada, obrigada!',
        dEndStella: 'Ela nem olhou pra mim. Só pro bichinho. ...Achei bom assim.',
        dEndGraham: 'Missão simples. Foi a primeira em muito tempo que não custou nada a ninguém.',
        dEndBen: 'Certo. Eu literalmente só carreguei um bicho de um lugar pro outro e virei herói. Aceito.',
        secretChick: 'Um pintinho. Pequeno, fácil de cuidar... e ninguém precisa saber até estar pronto.',
      },
      ...
      // ── Quest: Parafusadeira quebrada (Lucas) ──
      lucasDrill: {
        greetStella: 'Oi Lucas, como vai o projeto lá?',
        greetGraham: 'Oi Lucas, tudo certo com teu projeto?',
        greetBen: 'eai maninho, como tá indo o projeto?',
        hmm: 'hmm...',
        askFine: 'está tudo... bem?',
        evade: 'eh.. sim...',
        callStella: 'Luuucas.',
        callGraham: 'Garoto.',
        callBen: 'Lucas?',
        confess: 'nada de errado aconteceu! eu... eu... eu só... *olha para os lados, se aproxima de {name} e sussurra:*',
        brokeDrill: 'eu quebrei a parafusadeira do meu pai....',
        reactStella1: '*suspira* Pensei que era coisa séria, Lucas. Já ia falar com a sua mãe.',
        reactStella2: '...Ou com o seu pai. Mas ele não tá, né?',
        reactGraham1: 'Como posso garantir isso?',
        showBroken: 'eu.. eu te mostro ela quebrada!',
        reactGraham2: 'hmm, não precisa Lucas.',
        reactBen1: 'ela foi... cara?',
        brokenHowMuch: 'Um... um pouco',
        reactBen2: 'oh.... oh.....',
        choiceTell: 'Você precisa contar isso pro teu pai.',
        choiceIgnore: 'Isso é problema seu.',
        choiceHelp: 'Tá.. eu ajudo a resolver.',
        tellFearStella: 'ele vai se decepcionar comigo...',
        tellReassureStella1: 'Oh meu bem, ele vai entender, aliás, você é um bom garoto, não quebra as coisas por maldade',
        tellDoubtStella: 'e se ele não entender?',
        tellReassureStella2: '*abre um sorriso fraco*, ele vai Lucas, fica tranquilo ok? *Stella faz um cafune no cabelo do lucas*',
        tellResolveStella: '*cora* Tá bom... eu vou tentar...',
        tellComeStella: 'Você... vem comigo?',
        tellFearGraham: 'ele vai ficar decepcionado comigo..',
        tellReassureGraham1: 'Creio que ele entenderá, provavelmente dará um aviso, mas nada de grave jovem.',
        tellDoubtGraham: 'e se ele brigar? eu não quero que ele briga, quero pelo menos ser o exemplo entre meu irmão e irmãs',
        tellReassureGraham2: 'Você já é um bom exemplo.',
        tellReassureGraham3: 'Assumir a culpa só demonstrar ser um bom exemplo, uma atitude de maturidade.',
        tellResolveGraham: 'certo... você está certo, ele me ensina a ter atitude sempre antes de todos. Tá...',
        tellComeGraham: 'v-vou contar... quando ele chegar... você vem comigo?',
        tellFearBen: 'ele vai brigar comigo cara!',
        tellReassureBen1: 'ei fica tranquilo... John tem cara que entende tudo facil....',
        tellDoubtBen: 'mas será mesmo??',
        tellReassureBen2: '*faz um joinha e abre um sorriso* Tenho certeza que sim...',
        tellComeBen: 'hmm... *pensativo* pode vir comigo? então?',
        subOptCome: 'Te acompanho',
        subOptAlone: 'Você consegue sozinho',
        subOptForget: 'Melhor deixar pra lá...',
        ignoreStella1: '*Suspira* Olha.. Eu não sou a sua mãe, Lucas',
        ignoreStella2: 'você tem que resolver isso com seu pai.',
        ignoreLucasStella: '*olha para baixo, os olhos querendo lacrimejar*',
        ignoreGraham1: 'Você deveria ter prestado atenção. Agora vai ter que resolver isso com o seu pai garoto.',
        ignoreLucasGraham: 'M-mas...',
        ignoreGraham2: 'Não existe "mas", garoto. Você quebrou. Você conta. Você resolve.',
        ignoreBen1: 'Cara... sério?',
        ignoreLucasBen: 'foi sem querer!',
        ignoreBen2: 'Eu sei, mas isso não muda o fato que você quebrou uma coisa do seu pai.',
        ignoreLucasBen2: '*olhando para o chão* ...Tá',
        helpLucasAsk: '*levanta a cabeça rápido* Você ajuda mesmo?',
        helpLucasMoney: 'eu... eu tenho uns trocado guardado, mas não dá nem perto...',
        helpStella1: 'Dá pra comprar outra igual antes dele voltar, ninguém precisa saber.',
        helpDoubtStella: '*(hesita)* ...ninguém?',
        helpStella2: 'exato, ninguém! Segredinho nosso *piscadinha*',
        helpBlushStella: '*cora*',
        helpGraham1: 'Uma igual. Mesmo modelo, mesma marca. Ele vai reparar se for diferente.',
        helpDoubtGraham: 'você acha que ele repara?',
        helpGraham2: 'Eu repararia.',
        helpBen1: 'Relaxa, mano. A gente compra outra e ele nem vê.',
        helpDoubtBen: 'e se ele ver?',
        helpBen2: 'Aí a gente... *pensa* ...Aí a gente vê.',
        moneyBuy: 'Comprar uma nova (R$ {price})',
        moneyWait: 'Vou conseguir o dinheiro e comprar',
        comeStella: 'Claro! Somos parceiros nisso mesmo *abre um sorriso*',
        comeLucasStella: '*Sorri*, então vamos assim que ele voltar!',
        comeGraham: 'Eu te acompanho sim, mas você fala.',
        comeLucasGraham: 'Positivo *Lucas dá um leve sorriso e bate uma continencia*',
        comeBen: 'Vamos sim, assim que ele chegar!',
        comeLucasBen: 'Eh... certeza? tipo, ele vai tá meio cansado eu acho.',
        comeBen2: 'Quanto mais cedo resolvermos, melhor é.',
        aloneStella1: 'Hmhmhm, você já é bem hominho e corajoso em contar sobre o ocorrido para mim.',
        aloneStella2: 'Você consegue contar para ele sozinho, aliás acho que até ele fica feliz em ver seu filho assumir o erro por conta própria.',
        aloneLucasStella: 'B-bom.. Ok, eu confio na sua opinião! eu vou!',
        aloneGraham: 'Vá sozinho, é bem crescido não acha? John sentiria orgulho com sua sinceridade.',
        aloneLucasGraham: 'Tem razão... ok, eu vou!',
        aloneBen: 'olha, eu acho que ele ficaria contente se fosse só você... assim, talvez ele pense que você tem coragem em assumir a culpa?',
        aloneLucasBen: 'hmhmmmm, tem razão... espera, não vai me dizer que tá com medo dele?',
        aloneBen2: 'O que? não! nada disso, só quero dizer que ele ficaria feliz em ver o filho assumindo a culpa',
        dropStella1: '...Tudo bem. A gente esconde e ninguém precisa saber.',
        dropStella2: '*um sorriso que tenta acalmar* Mas se apertar, você me procura.',
        dropLucasStella: '*respira fundo* ...Tá.',
        dropGraham1: 'Então você esconde, garoto.',
        dropGraham2: 'Eu não vou contar. Mas o peso é seu.',
        dropLucasGraham: '*engole seco* ...Eu aguento.',
        dropBen1: 'Ih, deixa quieto então, mano.',
        dropBen2: 'Se ele perguntar, a gente não sabe de nada.',
        dropLucasBen: '...A gente não sabe de nada.',
        paidLucasReplace: '*guarda a parafusadeira nova na bancada do pai, do jeitinho que estava*',
        paidLucasThanks: 'Valeu... valeu mesmo.',
        paidLucasNotSmile: '*(mas ele não sorri)*',
        waitLucas: '*(assente, cabisbaixo)* ...Tá. Eu espero.',
        waitingJohnReminder: 'assim que o pai voltar, a gente conta.',
        johnSceneLucas1: 'Pai... eu preciso te falar uma coisa.',
        johnSceneJohn1: '*(sem olhar)* Fala.',
        johnSceneLucas2: 'Eu... eu quebrei a sua parafusadeira.',
        johnSceneJohn2: '*(pausa longa)*',
        johnSceneLucas3: 'Foi sem querer. Eu tava tentando mexer sozinho... eu queria aprender.',
        johnSceneJohn3: '*(olha pro Lucas)* E por que você tá me contando?',
        johnSceneLucas4: 'Porque... eu ia esconder. Mas eu não consegui.',
        johnSceneJohn4: 'Levanta a cabeça.',
        johnSceneLucas5: '*(levanta, com medo)*',
        johnSceneJohn5: 'Você quebrou. E veio me contar. Isso é atitude, Lucas.',
        johnSceneJohn6: '*(pro {name}, com um aceno seco)* ...Obrigado.',
        johnSceneEndStella: '*sorri baixinho* "Falei que ele ia entender."',
        johnSceneEndGraham: '*(acena de volta)*',
        johnSceneEndBen: '*solta o ar* "Ufa..."',
        followUpApproach: 'ei... {name}. pode falar um minuto?',
        followUpEntryStella: 'Oi, Lucas... tá com uma cara, meu bem.',
        followUpEntryGraham: 'Tem problema, garoto?',
        followUpEntryBen: 'E aí, maninho. Que cara é essa?',
        followUpTold: 'eu... contei pro meu pai.',
        followUpNotDrill: 'não pela parafusadeira. a nova tá lá, inteira. ele nem viu.',
        followUpSleepless: 'eu contei porque... não tava conseguindo dormir direito.',
        followUpAssume: '*(baixo, quase pra si)* ele sempre fala que homem de verdade assume. eu ia esconder... e não consegui.',
        followUpSorry: 'desculpa ter gastado teu dinheiro à toa.',
        followUpForget: 'eu tentei usar a nova pra esquecer. não deu.',
        followUpUpset: '*(levanta o olhar, pela primeira vez)* ...você tá chateado comigo?',
        confessOptRight: 'Você fez a coisa certa.',
        confessOptAfterAll: 'Depois de tudo aquilo?',
        confessOptOkay: 'Tudo bem. Eu entendo.',
        followUpRight1: '*(solta o ar, os ombros caem)* ...obrigado.',
        followUpRight2: 'o pai disse a mesma coisa. que atitude é assumir. até me elogiou.',
        followUpRight3: '*(o canto da boca sobe um tiquinho)* ele perguntou quem me ajudou a comprar. eu falei que foi você.',
        followUpAfter1: '*(encolhe)* eu sei... eu sei que gastei seu dinheiro.',
        followUpAfter2: 'eu devolvo. não sei como, mas eu devolvo.',
        followUpAfter3: '*(mais baixo)* só... não fica assim comigo, por favor.',
        followUpOkay1: '*(assente devagar, sem olhar nos olhos)*',
        followUpOkay2: 'você... não precisa entender. mas valeu.',
        followUpOkay3: '*(segura um sorriso triste)* eu não vou esquecer isso.',
        done: 'bom, com a parafusadeira nova, vou estar terminando meu projetinho! e meu pai tá supervisionando',
      },
