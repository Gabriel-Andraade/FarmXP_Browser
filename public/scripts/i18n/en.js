...
export default {
  ...
  saveSlots: {
    ...
    exportInvalid: 'This save is corrupted — export cancelled.',
    importSuccessUnverified: 'Save imported (integrity not verified).',
    importInvalidJson: 'Unreadable file — not valid JSON.',
    importNotASave: 'This file is not a Farming XP save.',
    importChecksumMismatch: 'File corrupted or edited — nothing was changed.',
