...
export default {
  ...
  saveSlots: {
    ...
    exportInvalid: 'Esta partida está dañada — exportación cancelada.',
    importSuccessUnverified: 'Partida importada (sin verificación de integridad).',
    importInvalidJson: 'Archivo ilegible — no es un JSON válido.',
    importNotASave: 'Este archivo no es una partida de Farming XP.',
    importChecksumMismatch: 'Archivo dañado o editado — no se cambió nada.',
