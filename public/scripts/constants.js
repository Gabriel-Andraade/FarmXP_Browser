...
export const TIMING = {
  ...
  MOUSE_UPDATE_INTERVAL_MS: 25,
  DEBUG_UPDATE_INTERVAL_MS: 200,
  NEEDS_UPDATE_INTERVAL_MS: 2000,
  SLEEP_ENERGY_RESTORE_INTERVAL_MS: 1000,
...
export const MOUSE_UPDATE_INTERVAL_MS = TIMING.MOUSE_UPDATE_INTERVAL_MS;
export const DEBUG_UPDATE_INTERVAL_MS = TIMING.DEBUG_UPDATE_INTERVAL_MS;
export const NEEDS_UPDATE_INTERVAL_MS = TIMING.NEEDS_UPDATE_INTERVAL_MS;
export const SLEEP_ENERGY_RESTORE_INTERVAL_MS = TIMING.SLEEP_ENERGY_RESTORE_INTERVAL_MS;
export const FEEDBACK_MESSAGE_DURATION_MS = TIMING.FEEDBACK_MESSAGE_DURATION_MS;
export const CONSUMPTION_BAR_DURATION_MS = TIMING.CONSUMPTION_BAR_DURATION_MS;
export const INIT_DELAY_MS = TIMING.INIT_DELAY_MS;
export const IDLE_STATE_MIN_MS = TIMING.IDLE_STATE_MIN_MS;
export const IDLE_STATE_MAX_MS = TIMING.IDLE_STATE_MAX_MS;
export const MOVE_STATE_MIN_MS = TIMING.MOVE_STATE_MIN_MS;
export const MOVE_STATE_MAX_MS = TIMING.MOVE_STATE_MAX_MS;
