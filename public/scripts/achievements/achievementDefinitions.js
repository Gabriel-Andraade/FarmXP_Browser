...
export const ACHIEVEMENTS = [
  ...
  // ─────────────── FARMING: crops (#218) ───────────────
  // Driven by cropSystem's cropPlanted / cropHarvested events.
  {
    id: 'first_plant',
    category: 'farming',
    icon: '🌱',
    i18nKey: 'achievements.firstPlant',
    type: 'single',
    target: 1,
    events: ['cropPlanted'],
    condition: () => true,
  ...
  {
    id: 'dedicated_planter',
    category: 'farming',
    icon: '🌾',
    i18nKey: 'achievements.dedicatedPlanter',
    type: 'cumulative',
    target: 250,
    events: ['cropPlanted'],
    condition: () => true,
  ...
  },
  {
    ...
    category: 'farming',
    icon: '🧺',
    i18nKey: 'achievements.firstHarvest',
    type: 'single',
    target: 1,
  ...
  },
  {
    ...
    category: 'farming',
    icon: '🌽',
    i18nKey: 'achievements.bountifulHarvest',
    type: 'cumulative',
    target: 100,
    events: ['cropHarvested'],
    condition: () => true,
